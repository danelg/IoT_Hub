...
public class RequestProcessor implements Runnable {
	...
	@Override
	public void run() {
		System.out.println("RequestProcessor - run()");
		try {
			...
			if (method.equals("GET")) {
				...
				System.out.println("RequestProcessor - run() - post el handler...");
				if (rsp != null) {
		...
		System.out.println("RequestProcessor - run() - fin");
	}
